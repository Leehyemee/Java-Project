...
public class SeatSelect extends JFrame {
	...
	public SeatSelect(Dto dto) {
		...
		JLabel selectTitle = new JLabel(dto.gettrainNum()+"기차 조회 화면");
		selectTitle.setFont(new Font("굴림", Font.BOLD, 13));
		...
		buyButton.setFont(new Font("굴림", Font.BOLD, 12));
		...
		jComboBox.setFont(new Font("굴림", Font.BOLD, 12));
