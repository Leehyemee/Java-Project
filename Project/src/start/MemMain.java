...
public class MemMain extends JFrame {
	...
	private JComboBox<String> Start_TF;
	private JComboBox<String> Arr_TF;
	...
	public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new MemMain(dto));
	...
	public MemMain(UserDto userdto) {
		...
		JComboBox<String> Adult_CB = new JComboBox<String>();
		Adult_CB.setModel(new DefaultComboBoxModel<String>(new String[] 
				{"어른 선택","어른1명", "어른2명", "어른3명", "어른4명", "어른5명", "어른6명", "어른7명"}));
		Adult_CB.setBounds(204, 119, 125, 26);
		contentPane.add(Adult_CB);
		
		
		JLabel PeopelInfo_LB = new JLabel("인원정보");
		PeopelInfo_LB.setFont(new Font("굴림체", Font.BOLD, 16));
		PeopelInfo_LB.setBounds(87, 118, 100, 26);
		contentPane.add(PeopelInfo_LB);
		
		JComboBox<String> Kid_CB = new JComboBox<String>();
		Kid_CB.setModel(new DefaultComboBoxModel(new String[] 
				{"6~12세 선택", "어린이1명", "어린이2명", "어린이3명", "어린이4명", 
						"어린이5명", "어린이6명", "어린이7명"}));
		Kid_CB.setBounds(363, 119, 125, 26);
		contentPane.add(Kid_CB);
		
		JComboBox Kid2_CB = new JComboBox();
		Kid2_CB.setModel(new DefaultComboBoxModel(new String[] 
				{"6세 미만 선택", "유아 1명", "유아 2명", "유아 3명", "유아 4명", 
						"유아 5명", "유아 6명", "유아 7명"}));
		...
		JLabel LineType_LB = new JLabel("여정경로");
		LineType_LB.setFont(new Font("굴림체", Font.BOLD, 15));
		LineType_LB.setBounds(87, 225, 74, 26);
		contentPane.add(LineType_LB);
		...
		JLabel StartStation_LB = new JLabel("출발역");
		StartStation_LB.setFont(new Font("굴림체", Font.BOLD, 15));
		StartStation_LB.setBounds(87, 272, 74, 26);
		contentPane.add(StartStation_LB);
		...
		ArrStation_LB.setFont(new Font("굴림체", Font.BOLD, 15));
		ArrStation_LB.setBounds(87, 326, 74, 26);
		contentPane.add(ArrStation_LB);
		
		JLabel StartDate_LB = new JLabel("출발일");
		StartDate_LB.setFont(new Font("굴림체", Font.BOLD, 15));
		StartDate_LB.setBounds(87, 380, 74, 26);
		contentPane.add(StartDate_LB);
		...
		Year_LB.setBounds(258, 390, 24, 15);
		...
		Month_LB.setBounds(339, 390, 24, 15);
		contentPane.add(Month_LB);
		...
		JLabel Day_LB = new JLabel("일");
		Day_LB.setBounds(430, 390, 24, 15);
		...
		JLabel Hour_LB = new JLabel("시");
		Hour_LB.setBounds(563, 389, 24, 15);
		contentPane.add(Hour_LB);
		...
		Mypage_BT.setBounds(658, 45, 223, 26);
		...
		JLabel TrainType_LB = new JLabel("열차 종류");
		TrainType_LB.setFont(new Font("굴림체", Font.BOLD, 15));
		TrainType_LB.setBounds(87, 172, 74, 26);
		contentPane.add(TrainType_LB);
		
		JComboBox<Object> Minute_CB = new JComboBox<Object>();
		Minute_CB.setModel(new DefaultComboBoxModel<Object>(new String[] 
				{"00", "05", "10", "15", "20", "25", "30", "35", "40", "45", "50", "55"}));
		Minute_CB.setBounds(601, 381, 87, 23);
		contentPane.add(Minute_CB);
		
		JLabel Minute_LB = new JLabel("분");
		Minute_LB.setBounds(692, 389, 24, 15);
		contentPane.add(Minute_LB);
		...
		Search_BT.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(dto.getAdultCount().contains("선택")
						&&dto.getChildCount().contains("선택")&&dto.getBabyCount().contains("선택")) {
