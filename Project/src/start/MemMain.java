...
public class MemMain extends JFrame {
	...
	public MemMain(Dto dto) {
		...
		comboBox.setModel(new DefaultComboBoxModel<Object>(new String[] 
				{"어른1명", "어른2명", "어른3명", "어른4명", "어른5명", "어른6명", "어른7명"}));
		...
		comboBox_1.setModel(new DefaultComboBoxModel<Object>(new String[] 
				{"6~12세", "어린이1명", "어린이2명", "어린이3명", "어린이4명", "어린이5명", "어린이6명", "어린이7명"}));
		...
		comboBox_2.setModel(new DefaultComboBoxModel<Object>(new String[] 
				{"6세 미만", "유아 1명", "유아 2명", "유아 3명", "유아 4명", "유아 5명", "유아 6명", "유아 7명"}));
		...
		JComboBox<Object> comboBox_2_1 = new JComboBox<Object>();
		comboBox_2_1.setModel(new DefaultComboBoxModel<Object>(new String[] {"기본", "1인석", "창측좌석", "내측좌석"}));
		comboBox_2_1.setBounds(87, 323, 84, 26);
		contentPane.add(comboBox_2_1);
		
		JComboBox<Object> comboBox_2_1_1 = new JComboBox<Object>();
		comboBox_2_1_1.setModel(new DefaultComboBoxModel<Object>(new String[] {"좌석방향", "순방향석", "역방향석"}));
		...
		JComboBox<Object> comboBox_3_3_1 = new JComboBox<Object>();
		comboBox_3_3_1.setModel(new DefaultComboBoxModel<Object>(new String[] 
				{"요일", "월", "화", "수", "목", "금", "토", "일"}));
